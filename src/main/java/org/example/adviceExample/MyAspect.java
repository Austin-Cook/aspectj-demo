package org.example.adviceExample;
...
public class MyAspect {
     ...
     */
    @Pointcut("execution(* org.example.adviceExample.MyClass.myMethod(..))")
     ...
     */
    @Pointcut("execution(* org.example.adviceExample.MyClass.myMethodAround(..))")
