package org.example.pointcutExample;
...
public class MyPointcutAspect {
     ...
     */
    @Pointcut("execution(public * org.example.pointcutExample.*.*(..))")
     ...
     */
    @Pointcut("execution(* org.example.pointcutExample.MyPointcutClass.myMethod(Integer))")
     ...
     */
    @Pointcut("execution(* org.example.pointcutExample.*.myMethod(..))")
